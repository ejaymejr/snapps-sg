...
getmenuHTML:function(menuobj){
	...
	for (var i=0; i<menuobj.items.length; i++){
		if (menuobj.items[i][0] != ""){
			frag+='<li><a href="' + menuobj.items[i][1] + '" target="' + menuobj.linktarget + '">' + menuobj.items[i][0] ;
			if(undefined != menuobj.items[i][2]){
				frag+='&nbsp;&nbsp;&nbsp;<forms>'+ menuobj.items[i][2] +'</forms>';
			}		
			frag+='</a></li>\n';
		}
