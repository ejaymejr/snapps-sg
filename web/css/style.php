...
$files = array('html', 'grid', 'menu',  'global_dashboard', 'layout', 'auxiliary_panel', 'calendar', 'bigtable', 'sortabletable', 'search', 'yui', 'customer','hr', 'conveyor'
               ,'star_rating', 'hr', 'anylinkmenu');
