...
class InspectionDateMapBuilder {

	
	const CLASS_NAME = 'lib.model.inspection.map.InspectionDateMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('inspection_date');
		$tMap->setPhpName('InspectionDate');
