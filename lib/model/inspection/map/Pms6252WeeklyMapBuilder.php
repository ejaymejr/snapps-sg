...
class Pms6252WeeklyMapBuilder {

	
	const CLASS_NAME = 'lib.model.inspection.map.Pms6252WeeklyMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pms_6252_weekly');
		$tMap->setPhpName('Pms6252Weekly');
