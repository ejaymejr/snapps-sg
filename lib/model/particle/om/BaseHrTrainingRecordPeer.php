...
abstract class BaseHrTrainingRecordPeer {
	...
	const PURCHASING = 'hr_training_record.PURCHASING';

	
	const GLASS_CONTAMINATED_GARMENT = 'hr_training_record.GLASS_CONTAMINATED_GARMENT';

	
	const ONSITE_PERSONNEL_TRAINING = 'hr_training_record.ONSITE_PERSONNEL_TRAINING';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(HrTrainingRecordPeer::PURCHASING);

		$criteria->addSelectColumn(HrTrainingRecordPeer::GLASS_CONTAMINATED_GARMENT);

		$criteria->addSelectColumn(HrTrainingRecordPeer::ONSITE_PERSONNEL_TRAINING);
