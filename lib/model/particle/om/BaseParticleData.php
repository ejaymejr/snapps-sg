...
abstract class BaseParticleData extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ParticleDataPeer::ID;
		}
	...
	public function setDateTime($v)
	{
		...
		if ($this->date_time !== $ts) {
			$this->date_time = $ts;
			$this->modifiedColumns[] = ParticleDataPeer::DATE_TIME;
		}
	...
	public function setCustomer($v)
	{
		...
		if ($this->customer !== $v) {
			$this->customer = $v;
			$this->modifiedColumns[] = ParticleDataPeer::CUSTOMER;
		}
	...
	public function setDepartment($v)
	{
		...
		if ($this->department !== $v) {
			$this->department = $v;
			$this->modifiedColumns[] = ParticleDataPeer::DEPARTMENT;
		}
	...
	public function setGarmentCode($v)
	{
		...
		if ($this->garment_code !== $v || $v === 'null') {
			$this->garment_code = $v;
			$this->modifiedColumns[] = ParticleDataPeer::GARMENT_CODE;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = ParticleDataPeer::TYPE;
		}
	...
	public function setPoint3($v)
	{
		...
		if ($this->point_3 !== $v || $v === 0) {
			$this->point_3 = $v;
			$this->modifiedColumns[] = ParticleDataPeer::POINT_3;
		}
	...
	public function setPoint3Spec($v)
	{
		...
		if ($this->point_3_spec !== $v || $v === 'null') {
			$this->point_3_spec = $v;
			$this->modifiedColumns[] = ParticleDataPeer::POINT_3_SPEC;
		}
	...
	public function setPoint5($v)
	{
		...
		if ($this->point_5 !== $v || $v === 0) {
			$this->point_5 = $v;
			$this->modifiedColumns[] = ParticleDataPeer::POINT_5;
		}
	...
	public function setPoint5Spec($v)
	{
		...
		if ($this->point_5_spec !== $v || $v === 'null') {
			$this->point_5_spec = $v;
			$this->modifiedColumns[] = ParticleDataPeer::POINT_5_SPEC;
		}
	...
	public function setNoOfTimesWash($v)
	{
		...
		if ($this->no_of_times_wash !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = ParticleDataPeer::NO_OF_TIMES_WASH;
		}
	...
	public function setWasher($v)
	{
		...
		if ($this->washer !== $v || $v === 'null') {
			$this->washer = $v;
			$this->modifiedColumns[] = ParticleDataPeer::WASHER;
		}
	...
	public function setDryer($v)
	{
		...
		if ($this->dryer !== $v || $v === 'null') {
			$this->dryer = $v;
			$this->modifiedColumns[] = ParticleDataPeer::DRYER;
		}
	...
	public function setRemarks($v)
	{
		...
		if ($this->remarks !== $v) {
			$this->remarks = $v;
			$this->modifiedColumns[] = ParticleDataPeer::REMARKS;
		}
	...
	public function setTester($v)
	{
		...
		if ($this->tester !== $v) {
			$this->tester = $v;
			$this->modifiedColumns[] = ParticleDataPeer::TESTER;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v || $v === 'null') {
			$this->created_by = $v;
			$this->modifiedColumns[] = ParticleDataPeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = ParticleDataPeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v || $v === 'null') {
			$this->modified_by = $v;
			$this->modifiedColumns[] = ParticleDataPeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = ParticleDataPeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating ParticleData object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ParticleDataPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ParticleDataPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += ParticleDataPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ParticleDataPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ParticleDataPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ParticleDataPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ParticleDataPeer::ID)) $criteria->add(ParticleDataPeer::ID, $this->id);
		if ($this->isColumnModified(ParticleDataPeer::DATE_TIME)) $criteria->add(ParticleDataPeer::DATE_TIME, $this->date_time);
		if ($this->isColumnModified(ParticleDataPeer::CUSTOMER)) $criteria->add(ParticleDataPeer::CUSTOMER, $this->customer);
		if ($this->isColumnModified(ParticleDataPeer::DEPARTMENT)) $criteria->add(ParticleDataPeer::DEPARTMENT, $this->department);
		if ($this->isColumnModified(ParticleDataPeer::GARMENT_CODE)) $criteria->add(ParticleDataPeer::GARMENT_CODE, $this->garment_code);
		if ($this->isColumnModified(ParticleDataPeer::TYPE)) $criteria->add(ParticleDataPeer::TYPE, $this->type);
		if ($this->isColumnModified(ParticleDataPeer::POINT_3)) $criteria->add(ParticleDataPeer::POINT_3, $this->point_3);
		if ($this->isColumnModified(ParticleDataPeer::POINT_3_SPEC)) $criteria->add(ParticleDataPeer::POINT_3_SPEC, $this->point_3_spec);
		if ($this->isColumnModified(ParticleDataPeer::POINT_5)) $criteria->add(ParticleDataPeer::POINT_5, $this->point_5);
		if ($this->isColumnModified(ParticleDataPeer::POINT_5_SPEC)) $criteria->add(ParticleDataPeer::POINT_5_SPEC, $this->point_5_spec);
		if ($this->isColumnModified(ParticleDataPeer::NO_OF_TIMES_WASH)) $criteria->add(ParticleDataPeer::NO_OF_TIMES_WASH, $this->no_of_times_wash);
		if ($this->isColumnModified(ParticleDataPeer::WASHER)) $criteria->add(ParticleDataPeer::WASHER, $this->washer);
		if ($this->isColumnModified(ParticleDataPeer::DRYER)) $criteria->add(ParticleDataPeer::DRYER, $this->dryer);
		if ($this->isColumnModified(ParticleDataPeer::REMARKS)) $criteria->add(ParticleDataPeer::REMARKS, $this->remarks);
		if ($this->isColumnModified(ParticleDataPeer::TESTER)) $criteria->add(ParticleDataPeer::TESTER, $this->tester);
		if ($this->isColumnModified(ParticleDataPeer::CREATED_BY)) $criteria->add(ParticleDataPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(ParticleDataPeer::DATE_CREATED)) $criteria->add(ParticleDataPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(ParticleDataPeer::MODIFIED_BY)) $criteria->add(ParticleDataPeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(ParticleDataPeer::DATE_MODIFIED)) $criteria->add(ParticleDataPeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ParticleDataPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new ParticleDataPeer();
		}
		return self::$peer;
	}
