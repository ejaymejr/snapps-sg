...
abstract class BaseIcData extends BaseObject  implements Persistent {
	...
	public function getNo2Spec()
	{

		return $this->no_2_spec;
	}
	...
	public function setNo2($v)
	{

		if ($this->no_2 !== $v || $v === 0) {
			$this->no_2 = $v;
			$this->modifiedColumns[] = IcDataPeer::NO_2;
		}

	} 
	
	public function setNo2Spec($v)
	{
		...
		if ($this->no_2_spec !== $v || $v === 'null') {
			$this->no_2_spec = $v;
			$this->modifiedColumns[] = IcDataPeer::NO_2_SPEC;
		}

	} 
	
	public function setBr($v)
	{

		if ($this->br !== $v || $v === 0) {
			$this->br = $v;
			$this->modifiedColumns[] = IcDataPeer::BR;
		}

	} 
	
	public function setBrSpec($v)
	{
		...
		if ($this->br_spec !== $v || $v === 'null') {
			$this->br_spec = $v;
			$this->modifiedColumns[] = IcDataPeer::BR_SPEC;
		}

	} 
	
	public function setLi($v)
	{

		if ($this->li !== $v || $v === 0) {
			$this->li = $v;
			$this->modifiedColumns[] = IcDataPeer::LI;
		}

	} 
	
	public function setLiSpec($v)
	{
		...
		if ($this->li_spec !== $v || $v === 'null') {
			$this->li_spec = $v;
			$this->modifiedColumns[] = IcDataPeer::LI_SPEC;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->no_2 = $rs->getFloat($startcol + 26);

			$this->no_2_spec = $rs->getString($startcol + 27);

			$this->br = $rs->getFloat($startcol + 28);

			$this->br_spec = $rs->getString($startcol + 29);

			$this->li = $rs->getFloat($startcol + 30);

			$this->li_spec = $rs->getString($startcol + 31);

			$this->washer = $rs->getString($startcol + 32);

			$this->dryer = $rs->getString($startcol + 33);

			$this->remarks = $rs->getString($startcol + 34);

			$this->tester = $rs->getString($startcol + 35);

			$this->garment_code = $rs->getString($startcol + 36);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 26:
				...
				break;
			case 27:
				return $this->getNo2Spec();
				break;
			case 28:
				return $this->getBr();
				break;
			case 29:
				return $this->getBrSpec();
				break;
			case 30:
				return $this->getLi();
				break;
			case 31:
				return $this->getLiSpec();
				break;
			case 32:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[26] => $this->getNo2(),
			$keys[27] => $this->getNo2Spec(),
			$keys[28] => $this->getBr(),
			$keys[29] => $this->getBrSpec(),
			$keys[30] => $this->getLi(),
			$keys[31] => $this->getLiSpec(),
			$keys[32] => $this->getWasher(),
			$keys[33] => $this->getDryer(),
			$keys[34] => $this->getRemarks(),
			$keys[35] => $this->getTester(),
			$keys[36] => $this->getGarmentCode(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 26:
				...
				break;
			case 27:
				$this->setNo2Spec($value);
				break;
			case 28:
				$this->setBr($value);
				break;
			case 29:
				$this->setBrSpec($value);
				break;
			case 30:
				$this->setLi($value);
				break;
			case 31:
				$this->setLiSpec($value);
				break;
			case 32:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[26], $arr)) $this->setNo2($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setNo2Spec($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setBr($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setBrSpec($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setLi($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setLiSpec($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setWasher($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setDryer($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setRemarks($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setTester($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setGarmentCode($arr[$keys[36]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(IcDataPeer::NO_2)) $criteria->add(IcDataPeer::NO_2, $this->no_2);
		if ($this->isColumnModified(IcDataPeer::NO_2_SPEC)) $criteria->add(IcDataPeer::NO_2_SPEC, $this->no_2_spec);
		if ($this->isColumnModified(IcDataPeer::BR)) $criteria->add(IcDataPeer::BR, $this->br);
		if ($this->isColumnModified(IcDataPeer::BR_SPEC)) $criteria->add(IcDataPeer::BR_SPEC, $this->br_spec);
		if ($this->isColumnModified(IcDataPeer::LI)) $criteria->add(IcDataPeer::LI, $this->li);
		if ($this->isColumnModified(IcDataPeer::LI_SPEC)) $criteria->add(IcDataPeer::LI_SPEC, $this->li_spec);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNo2($this->no_2);

		$copyObj->setNo2Spec($this->no_2_spec);

		$copyObj->setBr($this->br);

		$copyObj->setBrSpec($this->br_spec);

		$copyObj->setLi($this->li);

		$copyObj->setLiSpec($this->li_spec);
