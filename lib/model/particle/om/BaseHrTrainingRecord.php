...
abstract class BaseHrTrainingRecord extends BaseObject  implements Persistent {
	...
	protected $purchasing = 'null';


	
	protected $glass_contaminated_garment = 'null';


	
	protected $onsite_personnel_training = 'null';
	...
	public function getGlassContaminatedGarment()
	{

		return $this->glass_contaminated_garment;
	}

	
	public function getOnsitePersonnelTraining()
	{

		return $this->onsite_personnel_training;
	}
	...
	public function setPurchasing($v)
	{
		...
		if ($this->purchasing !== $v || $v === 'null') {
			$this->purchasing = $v;
			$this->modifiedColumns[] = HrTrainingRecordPeer::PURCHASING;
		}

	} 
	
	public function setGlassContaminatedGarment($v)
	{
		...
		if ($this->glass_contaminated_garment !== $v || $v === 'null') {
			$this->glass_contaminated_garment = $v;
			$this->modifiedColumns[] = HrTrainingRecordPeer::GLASS_CONTAMINATED_GARMENT;
		}

	} 
	
	public function setOnsitePersonnelTraining($v)
	{
		...
		if ($this->onsite_personnel_training !== $v || $v === 'null') {
			$this->onsite_personnel_training = $v;
			$this->modifiedColumns[] = HrTrainingRecordPeer::ONSITE_PERSONNEL_TRAINING;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->purchasing = $rs->getString($startcol + 28);

			$this->glass_contaminated_garment = $rs->getString($startcol + 29);

			$this->onsite_personnel_training = $rs->getString($startcol + 30);

			$this->external_course = $rs->getString($startcol + 31);

			$this->remarks = $rs->getString($startcol + 32);

			$this->verify = $rs->getString($startcol + 33);

			$this->created_by = $rs->getString($startcol + 34);

			$this->date_created = $rs->getTimestamp($startcol + 35, null);

			$this->modified_by = $rs->getString($startcol + 36);

			$this->date_modified = $rs->getTimestamp($startcol + 37, null);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 27:
				...
				break;
			case 28:
				return $this->getPurchasing();
				break;
			case 29:
				return $this->getGlassContaminatedGarment();
				break;
			case 30:
				return $this->getOnsitePersonnelTraining();
				break;
			case 31:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[28] => $this->getPurchasing(),
			$keys[29] => $this->getGlassContaminatedGarment(),
			$keys[30] => $this->getOnsitePersonnelTraining(),
			$keys[31] => $this->getExternalCourse(),
			$keys[32] => $this->getRemarks(),
			$keys[33] => $this->getVerify(),
			$keys[34] => $this->getCreatedBy(),
			$keys[35] => $this->getDateCreated(),
			$keys[36] => $this->getModifiedBy(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 27:
				...
				break;
			case 28:
				$this->setPurchasing($value);
				break;
			case 29:
				$this->setGlassContaminatedGarment($value);
				break;
			case 30:
				$this->setOnsitePersonnelTraining($value);
				break;
			case 31:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[28], $arr)) $this->setPurchasing($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setGlassContaminatedGarment($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setOnsitePersonnelTraining($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setExternalCourse($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setRemarks($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setVerify($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setCreatedBy($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setDateCreated($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setModifiedBy($arr[$keys[36]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(HrTrainingRecordPeer::PURCHASING)) $criteria->add(HrTrainingRecordPeer::PURCHASING, $this->purchasing);
		if ($this->isColumnModified(HrTrainingRecordPeer::GLASS_CONTAMINATED_GARMENT)) $criteria->add(HrTrainingRecordPeer::GLASS_CONTAMINATED_GARMENT, $this->glass_contaminated_garment);
		if ($this->isColumnModified(HrTrainingRecordPeer::ONSITE_PERSONNEL_TRAINING)) $criteria->add(HrTrainingRecordPeer::ONSITE_PERSONNEL_TRAINING, $this->onsite_personnel_training);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPurchasing($this->purchasing);

		$copyObj->setGlassContaminatedGarment($this->glass_contaminated_garment);

		$copyObj->setOnsitePersonnelTraining($this->onsite_personnel_training);
