...
class ParticleDataMapBuilder {

	
	const CLASS_NAME = 'lib.model.particle.map.ParticleDataMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('particle_data');
		$tMap->setPhpName('ParticleData');
