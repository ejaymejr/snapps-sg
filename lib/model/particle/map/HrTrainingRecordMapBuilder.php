...
class HrTrainingRecordMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('PURCHASING', 'Purchasing', 'string', CreoleTypes::CHAR, true, 3);

		$tMap->addColumn('GLASS_CONTAMINATED_GARMENT', 'GlassContaminatedGarment', 'string', CreoleTypes::CHAR, true, 3);

		$tMap->addColumn('ONSITE_PERSONNEL_TRAINING', 'OnsitePersonnelTraining', 'string', CreoleTypes::CHAR, true, 3);
