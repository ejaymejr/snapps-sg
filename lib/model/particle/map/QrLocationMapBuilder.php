...
class QrLocationMapBuilder {

	
	const CLASS_NAME = 'lib.model.particle.map.QrLocationMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('qr_location');
		$tMap->setPhpName('QrLocation');
		...
		$tMap->addColumn('REMARKS', 'Remarks', 'string', CreoleTypes::VARCHAR, true, 50);
