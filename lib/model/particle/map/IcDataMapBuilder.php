...
class IcDataMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('NO_2', 'No2', 'double', CreoleTypes::DECIMAL, true, 10);

		$tMap->addColumn('NO_2_SPEC', 'No2Spec', 'string', CreoleTypes::VARCHAR, true, 50);

		$tMap->addColumn('BR', 'Br', 'double', CreoleTypes::DECIMAL, true, 10);

		$tMap->addColumn('BR_SPEC', 'BrSpec', 'string', CreoleTypes::VARCHAR, true, 50);

		$tMap->addColumn('LI', 'Li', 'double', CreoleTypes::DECIMAL, true, 10);

		$tMap->addColumn('LI_SPEC', 'LiSpec', 'string', CreoleTypes::VARCHAR, true, 50);
