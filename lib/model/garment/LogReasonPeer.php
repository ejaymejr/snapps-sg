...
/**
 * Subclass for performing query and update operations on the 'log_reason' table.
 *
 * 
 *
 * @package lib.model.garment
 */ 
class LogReasonPeer extends BaseLogReasonPeer
{
    ...
    {        
        ...
        $c = clone($cd);
        $pager = new sfPropelPager('LogReason', $rowsPerPage);                    
