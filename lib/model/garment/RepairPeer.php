...
/**
 * Subclass for performing query and update operations on the 'repair' table.
 *
 * 
 *
 * @package lib.model.garment
 */ 
class RepairPeer extends BaseRepairPeer
{
    ...
    {        
        ...
        $c = clone($cd);
        $pager = new sfPropelPager('Repair', $rowsPerPage);                    
