...
class ScrapMapBuilder {

	
	const CLASS_NAME = 'lib.model.garment.map.ScrapMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('scrap');
		$tMap->setPhpName('Scrap');
		...
		$tMap->addColumn('SCRAP_DATE', 'ScrapDate', 'int', CreoleTypes::TIMESTAMP, true, null);
		...
		$tMap->addColumn('SCRAP_DATE_MODIFIED', 'ScrapDateModified', 'int', CreoleTypes::TIMESTAMP, true, null);

		$tMap->addColumn('SCRAP_DATE_COMPLETE_MODIFIED', 'ScrapDateCompleteModified', 'int', CreoleTypes::TIMESTAMP, true, null);
