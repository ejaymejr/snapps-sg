...
class OutscanBlankCompleteMapBuilder {

	
	const CLASS_NAME = 'lib.model.garment.map.OutscanBlankCompleteMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('outscan_blank_complete');
		$tMap->setPhpName('OutscanBlankComplete');

		$tMap->setUseIdGenerator(true);

		$tMap->addPrimaryKey('ID', 'Id', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('M_DATE_TIME', 'MDateTime', 'int', CreoleTypes::TIMESTAMP, true, null);
		...
		$tMap->addColumn('SIZE', 'Size', 'string', CreoleTypes::VARCHAR, true, 20);
		...
		$tMap->addColumn('STATUS', 'Status', 'string', CreoleTypes::VARCHAR, true, 10);
