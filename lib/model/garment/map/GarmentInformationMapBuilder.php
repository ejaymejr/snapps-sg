...
class GarmentInformationMapBuilder {
	...
	const CLASS_NAME = 'lib.model.garment.map.GarmentInformationMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('garment_information');
		...
		$tMap->addColumn('INSERTED_DATE', 'InsertedDate', 'int', CreoleTypes::TIMESTAMP, false, null);
