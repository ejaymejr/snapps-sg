...
class DeleteuserMapBuilder {

	
	const CLASS_NAME = 'lib.model.garment.map.DeleteuserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('deleteuser');
		$tMap->setPhpName('Deleteuser');
		...
		$tMap->addColumn('DELETED', 'Deleted', 'string', CreoleTypes::VARCHAR, true, 50);
