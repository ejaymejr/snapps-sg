...
class ShowaOutscanMapBuilder {

	
	const CLASS_NAME = 'lib.model.garment.map.ShowaOutscanMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('showa_outscan');
		$tMap->setPhpName('ShowaOutscan');
