...
/**
 * Subclass for performing query and update operations on the 'reject' table.
 *
 * 
 *
 * @package lib.model.garment
 */ 
class RejectPeer extends BaseRejectPeer
{
    ...
    {        
        ...
        $c = clone($cd);
        $pager = new sfPropelPager('Reject', $rowsPerPage);                    
