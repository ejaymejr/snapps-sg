...
abstract class BaseInscan extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = InscanPeer::ID;
		}
	...
	public function setGarmentCode($v)
	{
		...
		if ($this->garment_code !== $v || $v === 'null') {
			$this->garment_code = $v;
			$this->modifiedColumns[] = InscanPeer::GARMENT_CODE;
		}
	...
	public function setCustomer($v)
	{
		...
		if ($this->customer !== $v || $v === 'null') {
			$this->customer = $v;
			$this->modifiedColumns[] = InscanPeer::CUSTOMER;
		}
	...
	public function setDateTime($v)
	{
		...
		if ($this->date_time !== $ts) {
			$this->date_time = $ts;
			$this->modifiedColumns[] = InscanPeer::DATE_TIME;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v || $v === 'null') {
			$this->created_by = $v;
			$this->modifiedColumns[] = InscanPeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = InscanPeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v || $v === 'null') {
			$this->modified_by = $v;
			$this->modifiedColumns[] = InscanPeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = InscanPeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Inscan object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = InscanPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += InscanPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = InscanPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = InscanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = InscanPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InscanPeer::ID)) $criteria->add(InscanPeer::ID, $this->id);
		if ($this->isColumnModified(InscanPeer::GARMENT_CODE)) $criteria->add(InscanPeer::GARMENT_CODE, $this->garment_code);
		if ($this->isColumnModified(InscanPeer::CUSTOMER)) $criteria->add(InscanPeer::CUSTOMER, $this->customer);
		if ($this->isColumnModified(InscanPeer::DATE_TIME)) $criteria->add(InscanPeer::DATE_TIME, $this->date_time);
		if ($this->isColumnModified(InscanPeer::CREATED_BY)) $criteria->add(InscanPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(InscanPeer::DATE_CREATED)) $criteria->add(InscanPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(InscanPeer::MODIFIED_BY)) $criteria->add(InscanPeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(InscanPeer::DATE_MODIFIED)) $criteria->add(InscanPeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(InscanPeer::ID, $this->id);
