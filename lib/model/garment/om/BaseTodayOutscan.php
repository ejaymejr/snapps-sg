...
abstract class BaseTodayOutscan extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TodayOutscanPeer::ID;
		}
	...
	public function setGarmentCode($v)
	{
		...
		if ($this->garment_code !== $v || $v === 'null') {
			$this->garment_code = $v;
			$this->modifiedColumns[] = TodayOutscanPeer::GARMENT_CODE;
		}
	...
	public function setCustomer($v)
	{
		...
		if ($this->customer !== $v || $v === 'null') {
			$this->customer = $v;
			$this->modifiedColumns[] = TodayOutscanPeer::CUSTOMER;
		}
	...
	public function setDateTime($v)
	{
		...
		if ($this->date_time !== $ts) {
			$this->date_time = $ts;
			$this->modifiedColumns[] = TodayOutscanPeer::DATE_TIME;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating TodayOutscan object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			TodayOutscanPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TodayOutscanPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += TodayOutscanPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TodayOutscanPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TodayOutscanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TodayOutscanPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TodayOutscanPeer::ID)) $criteria->add(TodayOutscanPeer::ID, $this->id);
		if ($this->isColumnModified(TodayOutscanPeer::GARMENT_CODE)) $criteria->add(TodayOutscanPeer::GARMENT_CODE, $this->garment_code);
		if ($this->isColumnModified(TodayOutscanPeer::CUSTOMER)) $criteria->add(TodayOutscanPeer::CUSTOMER, $this->customer);
		if ($this->isColumnModified(TodayOutscanPeer::DATE_TIME)) $criteria->add(TodayOutscanPeer::DATE_TIME, $this->date_time);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TodayOutscanPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new TodayOutscanPeer();
		}
		return self::$peer;
	}
