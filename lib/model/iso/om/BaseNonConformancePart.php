...
abstract class BaseNonConformancePart extends BaseObject  implements Persistent {
	...
	protected $extend_exposure;


	
	protected $action_implemented;
	...
	public function getOtherNc()
	{

		return $this->other_nc;
	}

	
	public function getExtendExposure()
	{

		return $this->extend_exposure;
	}

	
	public function getActionImplemented()
	{

		return $this->action_implemented;
	}
	...
	public function setOtherNc($v)
	{
		...
		if ($this->other_nc !== $v) {
			$this->other_nc = $v;
			$this->modifiedColumns[] = NonConformancePartPeer::OTHER_NC;
		}

	} 
	
	public function setExtendExposure($v)
	{
		...
		if ($this->extend_exposure !== $v) {
			$this->extend_exposure = $v;
			$this->modifiedColumns[] = NonConformancePartPeer::EXTEND_EXPOSURE;
		}

	} 
	
	public function setActionImplemented($v)
	{
		...
		if ($this->action_implemented !== $v) {
			$this->action_implemented = $v;
			$this->modifiedColumns[] = NonConformancePartPeer::ACTION_IMPLEMENTED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->other_nc = $rs->getString($startcol + 57);

			$this->extend_exposure = $rs->getString($startcol + 58);

			$this->action_implemented = $rs->getString($startcol + 59);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 56:
				...
				break;
			case 57:
				return $this->getOtherNc();
				break;
			case 58:
				return $this->getExtendExposure();
				break;
			case 59:
				return $this->getActionImplemented();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[57] => $this->getOtherNc(),
			$keys[58] => $this->getExtendExposure(),
			$keys[59] => $this->getActionImplemented(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 56:
				...
				break;
			case 57:
				$this->setOtherNc($value);
				break;
			case 58:
				$this->setExtendExposure($value);
				break;
			case 59:
				$this->setActionImplemented($value);
				break;
		} 	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[57], $arr)) $this->setOtherNc($arr[$keys[57]]);
		if (array_key_exists($keys[58], $arr)) $this->setExtendExposure($arr[$keys[58]]);
		if (array_key_exists($keys[59], $arr)) $this->setActionImplemented($arr[$keys[59]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NonConformancePartPeer::OTHER_NC)) $criteria->add(NonConformancePartPeer::OTHER_NC, $this->other_nc);
		if ($this->isColumnModified(NonConformancePartPeer::EXTEND_EXPOSURE)) $criteria->add(NonConformancePartPeer::EXTEND_EXPOSURE, $this->extend_exposure);
		if ($this->isColumnModified(NonConformancePartPeer::ACTION_IMPLEMENTED)) $criteria->add(NonConformancePartPeer::ACTION_IMPLEMENTED, $this->action_implemented);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setOtherNc($this->other_nc);

		$copyObj->setExtendExposure($this->extend_exposure);

		$copyObj->setActionImplemented($this->action_implemented);
