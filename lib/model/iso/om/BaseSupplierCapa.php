...
abstract class BaseSupplierCapa extends BaseObject  implements Persistent {
	...
	public function getTokenExpiry($format = 'Y-m-d')
	{

		if ($this->token_expiry === null || $this->token_expiry === '') {
			return null;
		} elseif (!is_int($this->token_expiry)) {
						$ts = strtotime($this->token_expiry);
			if ($ts === -1 || $ts === false) { 				throw new PropelException("Unable to parse value of [token_expiry] as date/time value: " . var_export($this->token_expiry, true));
			}
		} else {
			$ts = $this->token_expiry;
		}
		if ($format === null) {
			return $ts;
		} elseif (strpos($format, '%') !== false) {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::ID;
		}
	...
	public function setReportNo($v)
	{
		...
		if ($this->report_no !== $v) {
			$this->report_no = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::REPORT_NO;
		}
	...
	public function setIssueDate($v)
	{
		...
		if ($this->issue_date !== $ts) {
			$this->issue_date = $ts;
			$this->modifiedColumns[] = SupplierCapaPeer::ISSUE_DATE;
		}
	...
	public function setResponseDate($v)
	{
		...
		if ($this->response_date !== $ts) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::RESPONSE_DATE;
		}
	...
	public function setFindings($v)
	{
		...
		if ($this->findings !== $v) {
			$this->findings = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::FINDINGS;
		}
	...
	public function setRootCauseAnalysis($v)
	{
		...
		if ($this->root_cause_analysis !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::ROOT_CAUSE_ANALYSIS;
		}
	...
	public function setContainmentPlan($v)
	{
		...
		if ($this->containment_plan !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CONTAINMENT_PLAN;
		}
	...
	public function setPreventivePlan($v)
	{
		...
		if ($this->preventive_plan !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::PREVENTIVE_PLAN;
		}
	...
	public function setVerificationOfCaPa($v)
	{
		...
		if ($this->verification_of_ca_pa !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::VERIFICATION_OF_CA_PA;
		}
	...
	public function setReportedBy($v)
	{
		...
		if ($this->reported_by !== $v) {
			$this->reported_by = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::REPORTED_BY;
		}
	...
	public function setSymptom($v)
	{
		...
		if ($this->symptom !== $v) {
			$this->symptom = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::SYMPTOM;
		}
	...
	public function setEraDescription($v)
	{
		...
		if ($this->era_description !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::ERA_DESCRIPTION;
		}
	...
	public function setEraEffectivity($v)
	{
		...
		if ($this->era_effectivity !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::ERA_EFFECTIVITY;
		}
	...
	public function setEraImplemented($v)
	{
		...
		if ($this->era_implemented !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::ERA_IMPLEMENTED;
		}
	...
	public function setEraCompleted($v)
	{
		...
		if ($this->era_completed !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::ERA_COMPLETED;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::TITLE;
		}
	...
	public function setTeam($v)
	{
		...
		if ($this->team !== $v) {
			$this->team = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::TEAM;
		}
	...
	public function setContEffectivity($v)
	{
		...
		if ($this->cont_effectivity !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CONT_EFFECTIVITY;
		}
	...
	public function setContImplemented($v)
	{
		...
		if ($this->cont_implemented !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CONT_IMPLEMENTED;
		}
	...
	public function setContCompleted($v)
	{
		...
		if ($this->cont_completed !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CONT_COMPLETED;
		}
	...
	public function setChosenPermCa($v)
	{
		...
		if ($this->chosen_perm_ca !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CHOSEN_PERM_CA;
		}
	...
	public function setChosenPermEffectivity($v)
	{
		...
		if ($this->chosen_perm_effectivity !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CHOSEN_PERM_EFFECTIVITY;
		}
	...
	public function setChosenPermImplemented($v)
	{
		...
		if ($this->chosen_perm_implemented !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CHOSEN_PERM_IMPLEMENTED;
		}
	...
	public function setChosenPermCompleted($v)
	{
		...
		if ($this->chosen_perm_completed !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CHOSEN_PERM_COMPLETED;
		}
	...
	public function setImplementedPermCa($v)
	{
		...
		if ($this->implemented_perm_ca !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::IMPLEMENTED_PERM_CA;
		}
	...
	public function setImplementedPermEffectivity($v)
	{
		...
		if ($this->implemented_perm_effectivity !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::IMPLEMENTED_PERM_EFFECTIVITY;
		}
	...
	public function setImplementedPermImplemented($v)
	{
		...
		if ($this->implemented_perm_implemented !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::IMPLEMENTED_PERM_IMPLEMENTED;
		}
	...
	public function setImplementedPermCompleted($v)
	{
		...
		if ($this->implemented_perm_completed !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::IMPLEMENTED_PERM_COMPLETED;
		}
	...
	public function setCarName($v)
	{
		...
		if ($this->car_name !== $v) {
			$this->car_name = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_NAME;
		}
	...
	public function setCarFollowupRequired($v)
	{
		...
		if ($this->car_followup_required !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_FOLLOWUP_REQUIRED;
		}
	...
	public function setCarFollowupDate($v)
	{
		...
		if ($this->car_followup_date !== $ts) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_FOLLOWUP_DATE;
		}
	...
	public function setCarCaStatus($v)
	{
		...
		if ($this->car_ca_status !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_CA_STATUS;
		}
	...
	public function setCarTitle($v)
	{
		...
		if ($this->car_title !== $v) {
			$this->car_title = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_TITLE;
		}
	...
	public function setCarPlanEffective($v)
	{
		...
		if ($this->car_plan_effective !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_PLAN_EFFECTIVE;
		}
	...
	public function setCarVerifiedBy($v)
	{
		...
		if ($this->car_verified_by !== $v) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_VERIFIED_BY;
		}
	...
	public function setCarClosureDate($v)
	{
		...
		if ($this->car_closure_date !== $ts) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::CAR_CLOSURE_DATE;
		}
	...
	public function setToken($v)
	{
		...
		if ($this->token !== $v) {
			$this->token = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::TOKEN;
		}
	...
	public function setTokenExpiry($v)
	{
		...
		if ($v !== null && !is_int($v)) {
			$ts = strtotime($v);
			if ($ts === -1 || $ts === false) { 				throw new PropelException("Unable to parse date/time value for [token_expiry] from input: " . var_export($v, true));
			}
		} else {
			$ts = $v;
		}
		if ($this->token_expiry !== $ts) {
			$this->token_expiry = $ts;
			$this->modifiedColumns[] = SupplierCapaPeer::TOKEN_EXPIRY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::DATE_CREATED;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::CREATED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = SupplierCapaPeer::DATE_MODIFIED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = SupplierCapaPeer::MODIFIED_BY;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->token = $rs->getString($startcol + 36);

			$this->token_expiry = $rs->getDate($startcol + 37, null);

			$this->date_created = $rs->getTimestamp($startcol + 38, null);

			$this->created_by = $rs->getString($startcol + 39);

			$this->date_modified = $rs->getTimestamp($startcol + 40, null);
			...
			throw new PropelException("Error populating SupplierCapa object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			SupplierCapaPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SupplierCapaPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += SupplierCapaPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SupplierCapaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SupplierCapaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SupplierCapaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			...
			$keys[36] => $this->getToken(),
			$keys[37] => $this->getTokenExpiry(),
			$keys[38] => $this->getDateCreated(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[36], $arr)) $this->setToken($arr[$keys[36]]);
		if (array_key_exists($keys[37], $arr)) $this->setTokenExpiry($arr[$keys[37]]);
		if (array_key_exists($keys[38], $arr)) $this->setDateCreated($arr[$keys[38]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SupplierCapaPeer::ID)) $criteria->add(SupplierCapaPeer::ID, $this->id);
		if ($this->isColumnModified(SupplierCapaPeer::REPORT_NO)) $criteria->add(SupplierCapaPeer::REPORT_NO, $this->report_no);
		if ($this->isColumnModified(SupplierCapaPeer::ISSUE_DATE)) $criteria->add(SupplierCapaPeer::ISSUE_DATE, $this->issue_date);
		if ($this->isColumnModified(SupplierCapaPeer::RESPONSE_DATE)) $criteria->add(SupplierCapaPeer::RESPONSE_DATE, $this->response_date);
		if ($this->isColumnModified(SupplierCapaPeer::FINDINGS)) $criteria->add(SupplierCapaPeer::FINDINGS, $this->findings);
		if ($this->isColumnModified(SupplierCapaPeer::ROOT_CAUSE_ANALYSIS)) $criteria->add(SupplierCapaPeer::ROOT_CAUSE_ANALYSIS, $this->root_cause_analysis);
		if ($this->isColumnModified(SupplierCapaPeer::CONTAINMENT_PLAN)) $criteria->add(SupplierCapaPeer::CONTAINMENT_PLAN, $this->containment_plan);
		if ($this->isColumnModified(SupplierCapaPeer::PREVENTIVE_PLAN)) $criteria->add(SupplierCapaPeer::PREVENTIVE_PLAN, $this->preventive_plan);
		if ($this->isColumnModified(SupplierCapaPeer::VERIFICATION_OF_CA_PA)) $criteria->add(SupplierCapaPeer::VERIFICATION_OF_CA_PA, $this->verification_of_ca_pa);
		if ($this->isColumnModified(SupplierCapaPeer::REPORTED_BY)) $criteria->add(SupplierCapaPeer::REPORTED_BY, $this->reported_by);
		if ($this->isColumnModified(SupplierCapaPeer::SYMPTOM)) $criteria->add(SupplierCapaPeer::SYMPTOM, $this->symptom);
		if ($this->isColumnModified(SupplierCapaPeer::ERA_DESCRIPTION)) $criteria->add(SupplierCapaPeer::ERA_DESCRIPTION, $this->era_description);
		if ($this->isColumnModified(SupplierCapaPeer::ERA_EFFECTIVITY)) $criteria->add(SupplierCapaPeer::ERA_EFFECTIVITY, $this->era_effectivity);
		if ($this->isColumnModified(SupplierCapaPeer::ERA_IMPLEMENTED)) $criteria->add(SupplierCapaPeer::ERA_IMPLEMENTED, $this->era_implemented);
		if ($this->isColumnModified(SupplierCapaPeer::ERA_COMPLETED)) $criteria->add(SupplierCapaPeer::ERA_COMPLETED, $this->era_completed);
		if ($this->isColumnModified(SupplierCapaPeer::TITLE)) $criteria->add(SupplierCapaPeer::TITLE, $this->title);
		if ($this->isColumnModified(SupplierCapaPeer::TEAM)) $criteria->add(SupplierCapaPeer::TEAM, $this->team);
		if ($this->isColumnModified(SupplierCapaPeer::CONT_EFFECTIVITY)) $criteria->add(SupplierCapaPeer::CONT_EFFECTIVITY, $this->cont_effectivity);
		if ($this->isColumnModified(SupplierCapaPeer::CONT_IMPLEMENTED)) $criteria->add(SupplierCapaPeer::CONT_IMPLEMENTED, $this->cont_implemented);
		if ($this->isColumnModified(SupplierCapaPeer::CONT_COMPLETED)) $criteria->add(SupplierCapaPeer::CONT_COMPLETED, $this->cont_completed);
		if ($this->isColumnModified(SupplierCapaPeer::CHOSEN_PERM_CA)) $criteria->add(SupplierCapaPeer::CHOSEN_PERM_CA, $this->chosen_perm_ca);
		if ($this->isColumnModified(SupplierCapaPeer::CHOSEN_PERM_EFFECTIVITY)) $criteria->add(SupplierCapaPeer::CHOSEN_PERM_EFFECTIVITY, $this->chosen_perm_effectivity);
		if ($this->isColumnModified(SupplierCapaPeer::CHOSEN_PERM_IMPLEMENTED)) $criteria->add(SupplierCapaPeer::CHOSEN_PERM_IMPLEMENTED, $this->chosen_perm_implemented);
		if ($this->isColumnModified(SupplierCapaPeer::CHOSEN_PERM_COMPLETED)) $criteria->add(SupplierCapaPeer::CHOSEN_PERM_COMPLETED, $this->chosen_perm_completed);
		if ($this->isColumnModified(SupplierCapaPeer::IMPLEMENTED_PERM_CA)) $criteria->add(SupplierCapaPeer::IMPLEMENTED_PERM_CA, $this->implemented_perm_ca);
		if ($this->isColumnModified(SupplierCapaPeer::IMPLEMENTED_PERM_EFFECTIVITY)) $criteria->add(SupplierCapaPeer::IMPLEMENTED_PERM_EFFECTIVITY, $this->implemented_perm_effectivity);
		if ($this->isColumnModified(SupplierCapaPeer::IMPLEMENTED_PERM_IMPLEMENTED)) $criteria->add(SupplierCapaPeer::IMPLEMENTED_PERM_IMPLEMENTED, $this->implemented_perm_implemented);
		if ($this->isColumnModified(SupplierCapaPeer::IMPLEMENTED_PERM_COMPLETED)) $criteria->add(SupplierCapaPeer::IMPLEMENTED_PERM_COMPLETED, $this->implemented_perm_completed);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_NAME)) $criteria->add(SupplierCapaPeer::CAR_NAME, $this->car_name);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_FOLLOWUP_REQUIRED)) $criteria->add(SupplierCapaPeer::CAR_FOLLOWUP_REQUIRED, $this->car_followup_required);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_FOLLOWUP_DATE)) $criteria->add(SupplierCapaPeer::CAR_FOLLOWUP_DATE, $this->car_followup_date);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_CA_STATUS)) $criteria->add(SupplierCapaPeer::CAR_CA_STATUS, $this->car_ca_status);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_TITLE)) $criteria->add(SupplierCapaPeer::CAR_TITLE, $this->car_title);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_PLAN_EFFECTIVE)) $criteria->add(SupplierCapaPeer::CAR_PLAN_EFFECTIVE, $this->car_plan_effective);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_VERIFIED_BY)) $criteria->add(SupplierCapaPeer::CAR_VERIFIED_BY, $this->car_verified_by);
		if ($this->isColumnModified(SupplierCapaPeer::CAR_CLOSURE_DATE)) $criteria->add(SupplierCapaPeer::CAR_CLOSURE_DATE, $this->car_closure_date);
		if ($this->isColumnModified(SupplierCapaPeer::TOKEN)) $criteria->add(SupplierCapaPeer::TOKEN, $this->token);
		if ($this->isColumnModified(SupplierCapaPeer::TOKEN_EXPIRY)) $criteria->add(SupplierCapaPeer::TOKEN_EXPIRY, $this->token_expiry);
		if ($this->isColumnModified(SupplierCapaPeer::DATE_CREATED)) $criteria->add(SupplierCapaPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(SupplierCapaPeer::CREATED_BY)) $criteria->add(SupplierCapaPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(SupplierCapaPeer::DATE_MODIFIED)) $criteria->add(SupplierCapaPeer::DATE_MODIFIED, $this->date_modified);
		if ($this->isColumnModified(SupplierCapaPeer::MODIFIED_BY)) $criteria->add(SupplierCapaPeer::MODIFIED_BY, $this->modified_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SupplierCapaPeer::ID, $this->id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTokenExpiry($this->token_expiry);
	...
	{
		if (self::$peer === null) {
			self::$peer = new SupplierCapaPeer();
		}
		return self::$peer;
	}
