...
abstract class BaseNonConformancePartPeer {
	...
	const OTHER_NC = 'non_conformance_part.OTHER_NC';

	
	const EXTEND_EXPOSURE = 'non_conformance_part.EXTEND_EXPOSURE';

	
	const ACTION_IMPLEMENTED = 'non_conformance_part.ACTION_IMPLEMENTED';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NonConformancePartPeer::OTHER_NC);

		$criteria->addSelectColumn(NonConformancePartPeer::EXTEND_EXPOSURE);

		$criteria->addSelectColumn(NonConformancePartPeer::ACTION_IMPLEMENTED);
