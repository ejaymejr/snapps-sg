...
/**
 * Subclass for performing query and update operations on the 'plastic_bag' table.
 *
 * 
 *
 * @package lib.model.iso
 */ 
class PlasticBagPeer extends BasePlasticBagPeer
{
    ...
    {        
        ...
        $c = clone($cd);
        $pager = new sfPropelPager('PlasticBag', $rowsPerPage);                    
