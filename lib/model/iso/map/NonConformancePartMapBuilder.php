...
class NonConformancePartMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('OTHER_NC', 'OtherNc', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('EXTEND_EXPOSURE', 'ExtendExposure', 'string', CreoleTypes::VARCHAR, false, 255);

		$tMap->addColumn('ACTION_IMPLEMENTED', 'ActionImplemented', 'string', CreoleTypes::VARCHAR, false, 255);
