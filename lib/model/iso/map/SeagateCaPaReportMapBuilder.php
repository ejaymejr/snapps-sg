...
class SeagateCaPaReportMapBuilder {

	
	const CLASS_NAME = 'lib.model.iso.map.SeagateCaPaReportMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('seagate_ca_pa_report');
		$tMap->setPhpName('SeagateCaPaReport');
