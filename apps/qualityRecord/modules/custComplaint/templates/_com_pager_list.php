...
$desc = $record->getComplainDateTime()? DateUtils::DUFormat('l jS \of F Y ', $record->getComplainDateTime()) : '';
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'custComplaint/complaintEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'custComplaint/complaintDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getComplainDateTime() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCompanyName() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCustomerNumber() ?></td>    
