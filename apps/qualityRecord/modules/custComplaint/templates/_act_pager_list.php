...
$desc = $record->getDateTime()? DateUtils::DUFormat('l jS \of F Y ', $record->getDateTime()) : '';
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'custComplaint/actionReviewEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'custComplaint/actionReviewDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCaseAction() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getReviewedBy() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getReviewDate() ?></td>    
