...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'contractMgt/contractEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'contractMgt/contractDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getContractNo() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getRemarks() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getStartDate() ?></td>    
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getEndDate() ?></td>
