...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Temperature Verification Reading', url_for('micronclean/washingMachineTempAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => '',
	'pagerTemplate'  => 'washingmachinetemp_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_washingmachinetemp_grid_headers')
);
