...
$desc = $record->getCustomer() . ' - ' .$record->getType();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/veritasEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/veritasDelete?id=' . $record->getId(),
