...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/washingMachineLoadEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/washingMachineLoadDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getWtScale() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getWtDisplay() ?></td>
