...
<div class="grid-toolbar-2"><?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Veritas Helmke Drum', url_for('micronclean/veritasAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'veritas_list_header_search',
    'pagerTemplate'  => 'veritas_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_ver_grid_headers')
);
