...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('micronclean/washingMachineTempAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
	<div align="center">
<table width="90%" class="FORMtable" border="0" cellpadding="1"	cellspacing="0">
	<tr><td>
		<table width="100%" class="FORMtable" border="0" cellpadding="4"cellspacing="0">
			<tr><td height="32" colspan="6" align="center" bgcolor="#FFAC25" nowrap><span style="color: #FFF"><H2>WASHING MACHINE TEMPERATURE VERIFICATION</H2></span></td></tr>
			<tr>
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>Temperature on Thermometer</td>
				<td class="FORMcell-right" nowrap><?php
				echo HTMLForm::Error('temp_thermometer');
                echo input_tag('temp_thermometer', $sf_params->get('temp_thermometer'), 'size="25"')				?>
                </td>
				<td class="FORMcell-left FORMlabel" nowrap>&deg;C &nbsp;
				</td>
			</tr>			
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>Temperature on Display</td>
				<td class="FORMcell-right" nowrap><?php
				echo HTMLForm::Error('temp_display');
                echo input_tag('temp_display', $sf_params->get('temp_display'), 'size="25"')				?>
                </td>
				<td class="FORMcell-left FORMlabel" nowrap>&deg;C &nbsp;
				</td>
			</tr>
