...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/ultrasonicEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/ultrasonicDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getPower() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getEquipmentName() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getDoneBy() ?></td>
