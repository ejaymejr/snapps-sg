...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/washingMachineTempEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/washingMachineTempDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getTempThermometer() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getTempDisplay() ?></td>
