...
<tr class="dgts" style="display:<?php echo $sf_params->get('commit', false) !== false ? '\'\'' : 'none' ?>;" id="<?php echo $searchContainerID ?>">
    ...
    <td><?php echo input_tag('frequency', $sf_params->get('frequency'), 'size="20"') ?></td>
    <td><?php echo input_tag('power', $sf_params->get('power'), 'size="20"') ?></td>
    <td><?php echo input_tag('equipment_name', $sf_params->get('equipment_name'), 'size="20"') ?></td>
    <td><?php echo input_tag('done_by', $sf_params->get('done_by'), 'size="20"') ?></td>    
