...
$desc = $record->getDateTime() . ' - ' .$record->getMachineNo();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/washingMachineDoseEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/washingMachineDoseDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getVolumeDispensed() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getTimeTaken() ?></td>
