...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Load Verification Reading', url_for('micronclean/washingMachineLoadAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => '',
	'pagerTemplate'  => 'washingmachineload_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_washingmachineload_grid_headers')
);
