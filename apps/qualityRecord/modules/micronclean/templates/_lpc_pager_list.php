...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/lpcEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/lpcDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCalibratedBy() ?></td>
