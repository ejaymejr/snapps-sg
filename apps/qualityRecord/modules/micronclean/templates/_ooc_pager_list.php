...
$desc = $record->getDateTime() . ' - ' .$record->getInvestigateBy();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/oocEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/oocDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getObservation() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getInvestigateBy() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getPropAction() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getReviewBy() ?></td>
