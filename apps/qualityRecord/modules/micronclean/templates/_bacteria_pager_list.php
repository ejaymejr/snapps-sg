...
$desc = $record->getTransDate();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/bacteriaTestEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/bacteriaTestDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo DateUtils::DUFormat('Y-m-d', $record->getTransDate() ) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCleanroom() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getAreaA() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getAreaB() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getFoldingTableA() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getFoldingTableB() ?></td>
