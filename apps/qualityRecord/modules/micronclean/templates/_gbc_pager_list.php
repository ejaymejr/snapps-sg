...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/garmentBacteriaEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/garmentBacteriaDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo DateUtils::DUFormat('Y-m-d', $record->getDateTime() ) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCustomer() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getDepartment() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getBacteriaCount() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getType() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getWasher() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getDryer() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getTester() ?></td>
