...
$desc = $record->getDateTime() . ' - ' .$record->getLcl();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/waterEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/waterDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getResistivity() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getLcl() ?></td>
