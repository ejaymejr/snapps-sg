...
$desc = $record->getFilterArea() . ' - ' .$record->getDateTime();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'micronclean/airEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'micronclean/airDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getXData() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getFilterArea() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getTemperature() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getRh() ?></td>
