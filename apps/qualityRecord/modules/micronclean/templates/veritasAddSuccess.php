...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('micronclean/veritasAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
	<div align="center">
<table width="90%" class="FORMtable" border="0" cellpadding="1"	cellspacing="0">
	<tr><td>
		<table width="100%" class="FORMtable" border="0" cellpadding="4"cellspacing="0">
			<tr><td height="32" colspan="6" align="center" bgcolor="#FFAC25" nowrap><span style="color: #FFF"><H2>VERITAS HELMKE DATA SHEET</H2></span></td></tr>
			<tr>
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>0.3um & LARGER<500</td>
				<td class="FORMcell-right" nowrap><?php
				echo input_tag('point_5', $sf_params->get('point_5'), 'size="25"');
                ?>
                </td>
				<td class="FORMcell-left FORMlabel" nowrap>0.3um & LARGER<500 SPEC</td>
				<td class="FORMcell-right FORMlabel" nowrap><?php
				echo input_tag('point_5_spec', $sf_params->get('point_5_spec'), 'size="25"')
				?>
				</td>
			</tr>
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>0.5um & LARGER<300</td>
				<td class="FORMcell-right" nowrap><?php
				echo input_tag('point_3', $sf_params->get('point_3'), 'size="25"');
                ?>
                </td>
				<td class="FORMcell-left FORMlabel" nowrap>0.5um & LARGER<300 SPEC</td>
				<td class="FORMcell-right FORMlabel" nowrap><?php
				echo input_tag('point_3_spec', $sf_params->get('point_3_spec'), 'size="25"')
				?>
				</td>
			</tr>
			<tr>
