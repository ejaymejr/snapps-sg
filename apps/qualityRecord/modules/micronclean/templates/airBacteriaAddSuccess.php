...
<?php
    $area = array('LOCATION A'=> ' -LOCATION A- ', 'LOCATION B'=> ' -LOCATION B- ', 'FOLDING TABLE'=> ' -FOLDING TABLE- ');
?>

<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('micronclean/airBacteriaAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
	<div align="center">
<table width="90%" class="FORMtable" border="0" cellpadding="1"	cellspacing="0">
	<tr><td>
		<table width="100%" class="FORMtable" border="0" cellpadding="4"cellspacing="0">
			<tr><td height="32" colspan="6" align="center" bgcolor="#FFAC25" nowrap><span style="color: #FFF"><H2>CLEANROOM BACTERIA COUNT DATA SHEET</H2></span></td></tr>
			<tr>
			...
			<tr>
				...
				<td class="FORMcell-right" nowrap><?php
		        echo input_tag('tester', $sf_params->get('tester'), 'size="20" type= "hidden"');
