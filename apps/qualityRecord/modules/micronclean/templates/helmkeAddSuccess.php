...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('micronclean/helmkeAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
	<div align="center">
