...
$desc = DateUtils::DUFormat('l jS \of F Y ', $record->getInspectionDate());
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'diwater/dailyInspectionEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'diwater/dailyInspectionDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getInspectionType() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $desc ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getInspectionDate() ?></td>    
