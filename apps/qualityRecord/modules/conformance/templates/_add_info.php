...
<table width="100%" class="FORMtable" border="0" cellpadding="4"
	...
	<tr>
		<td class="FORMcell-right" nowrap></td>
		<td class="FORMcell-left FORMlabel" nowrap>Other NC's</td>
		<td colspan="3" class="FORMcell-right" nowrap><?php
		echo textarea_tag('other_nc', $sf_params->get('other_nc'), 'size=75x4')				
		?>
	...
	<tr>
		<td class="FORMcell-right" nowrap></td>
		<td class="FORMcell-left FORMlabel" nowrap>Extend of Exposure</td>
		<td colspan="3" class="FORMcell-right" nowrap><?php
		echo textarea_tag('extend_exposure', $sf_params->get('extend_exposure'), 'size=75x4')
		?>
		<span class="negative"></span>
		</td>
	</tr>
	<tr>
		<td class="FORMcell-right" nowrap></td>
		<td class="FORMcell-left FORMlabel" nowrap>Actions Implemented</td>
		<td colspan="3" class="FORMcell-right" nowrap><?php
		echo textarea_tag('action_implemented', $sf_params->get('action_implemented'), 'size=75x4')
		?>
		<span class="negative"></span>
		</td>
	</tr>
