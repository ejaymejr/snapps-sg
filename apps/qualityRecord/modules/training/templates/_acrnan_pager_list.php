...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'training/acroNanoTrainingEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'training/acroNanoTrainingDelete?id=' . $record->getId(),
...
$certLink = link_to(image_tag('pdfFile.jpg'), 'training/acroNanoCertificatePDF?id=' . $record->getId());
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo ($record->getPvaVmi() == "YES"? "YES" : "" ) ?></td>
