...
$desc = $record->getDescription() . ' - ' .$record->getDateFrom();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'training/trainingEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'training/trainingDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getDescription() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getPlaceHeld() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getNameTrainor() ?></td>
