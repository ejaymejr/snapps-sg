...
$desc = $record->getAuditedDate()? DateUtils::DUFormat('l jS \of F Y ', $record->getAuditedDate()) : '';
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'internalAudit/auditEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'internalAudit/auditDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignLeft alignTop" nowrap > <?php echo $record->getAuditedDate() ?></td>
    <td class="alignLeft alignTop" nowrap > <?php echo $record->getAuditor() ?></td>
    <td class="alignLeft alignTop" nowrap > <?php echo $record->getCorrectivePreventiveActionReportNo() ?></td>
    <td class="alignLeft alignTop" nowrap > <?php echo $record->getAreaAudited() ?></td>    
    <td class="alignLeft alignTop" nowrap ><?php echo $record->getObservation() ?></td>
