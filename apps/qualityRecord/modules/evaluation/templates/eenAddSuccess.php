...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('evaluation/eenAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
	<div align="center">
<table width="90%" class="FORMtable" border="0" cellpadding="1"	cellspacing="0">
	<tr><td>
		<table width="100%" class="FORMtable" border="0" cellpadding="4"cellspacing="0">
			<tr><td height="35" colspan="6" align="center" bgcolor="#FFAC25" nowrap><span style="color: #FFF"><H2>ENGINEERING EVALUATION NOTICE</H2></span></td></tr>		
			<tr>
				...
				<td width="10" class="FORMcell-left FORMlabel" nowrap>EEN NUMBER</td>
				<td class="FORMcell-right" nowrap><?php
				echo input_tag('een_no', $sf_params->get('een_no'), 'size="15"');
			...
			<tr>
				...
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo textarea_tag('problem_description', $sf_params->get('problem_description'), 'size=75x5')
				?></td>
			</tr>
			<tr>
				<td class="FORMcell-right" nowrap></td>
			...
			<tr>
				...
				echo $sf_params->get('keyed_in_by');
				?></td>
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>FLOW DESCRIPTION OF THE EVALUATION</td>
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo textarea_tag('flow_description', $sf_params->get('flow_description'), 'size=75x3')
				?></td>
			</tr>
			<tr>
				<td class="FORMcell-right" nowrap></td>
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>DATA COMPLETION DATE</td>
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo HTMLForm::DrawDateInput('data_completion_date', $sf_params->get('data_completion_date'), XIDX::next(), XIDX::next(), ' size="12" ');
				?></td>
			</tr>
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>QTY FOR RUN REQUIRED</td>
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo textarea_tag('qty_for_run', $sf_params->get('qty_for_run'), 'size=75x3')
				?></td>
			</tr>
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>RUN COMPLETION DATE</td>
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo HTMLForm::DrawDateInput('run_completion_date', $sf_params->get('run_completion_date'), XIDX::next(), XIDX::next(), ' size="12" ');
				?></td>
			</tr>			
			<tr>
				<td class="FORMcell-right" nowrap></td>
			...
			<tr>
				...
				?></td>
				<td class="FORMcell-left FORMlabel" nowrap>DATE OF FOLLOW UP</td>
				<td class="FORMcell-right" nowrap><?php
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>EVIDENCE</td>
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo textarea_tag('evidence', $sf_params->get('evidence'), 'size=75x3')
				?></td>
			</tr>
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>DISPOSITION OF MATERIAL</td>
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo textarea_tag('disposition_of_material', $sf_params->get('disposition_of_material'), 'size=75x3')
				?></td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" class="FORMcell-right" nowrap><?php
				echo textarea_tag('additional_sheet', $sf_params->get('additional_sheet'), 'size=75x10')
				?></td>
			</tr>			
			<tr>
				<td class="FORMcell-right" nowrap></td>
...
<table>
	<tr>
		<td class="alignRight" nowrap>MC Record Sheet # 30 Revision: 001 Issue Date: 8/24/2009</td>
	</tr>
	<tr>
