...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'capa/qanEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'capa/qanDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getQanNo() ?></td>
    <td class="alignLeft alignTop" nowrap > <?php echo  (strlen($record->getProblemDescription())> 100? substr($record->getProblemDescription(), 0, 100) . '...' :$record->getProblemDescription()) ?></td>    
