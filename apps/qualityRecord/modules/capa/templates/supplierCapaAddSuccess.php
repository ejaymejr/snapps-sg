...
<?php 
	if (! $sf_params->get('token') && ! ($sf_user->isAuthenticated())):
		return;
	endif; 
?>
<?php
...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('capa/supplierCapaAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
<div align="center">
<table width="90%" class="FORMtable" border="0" cellpadding="1"
	...
	<tr>
		...
		<table width="100%" class="FORMtable" border="0" cellpadding="4"
			cellspacing="0">
			<?php if (! $sf_params->get('token')): ?>
			
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>SUPPLIER EMAIL</td>
				<td class="FORMcell-right" nowrap><?php
					echo input_tag('email_to', $sf_params->get('email_to'), 'size="30"');
				?>&nbsp;
				<input type="submit" name="emailButton" value=" Let Supplier Fill up this Form " class="submit-button">
				</td>
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>SUPPLIER</td>
				<td class="FORMcell-right" nowrap><?php
			...
			<tr>
				<td class="FORMcell-right" nowrap></td>
				<td class="FORMcell-left FORMlabel" nowrap>NON CONFORMING MATERIAL <BR>
				CONCERN</td>
