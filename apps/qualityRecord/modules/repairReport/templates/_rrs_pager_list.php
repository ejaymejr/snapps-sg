...
$desc = $record->getRepairDate()? DateUtils::DUFormat('l jS \of F Y ', $record->getRepairDate()) : '';
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'repairReport/repairReportEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'repairReport/repairReportDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getRepairDate() ?></td>
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getGarmentType() ?></td>    
    <td class="alignCenter alignTop" nowrap ><?php echo $record->getRepairType() ?></td>
    <td class="alignCenter alignTop" nowrap ><?php echo $record->getRemarks() ?></td>
