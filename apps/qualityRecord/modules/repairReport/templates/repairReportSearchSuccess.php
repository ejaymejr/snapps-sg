...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Repair Report', url_for('repairReport/repairReportAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'rrs_list_header_search',
    'pagerTemplate'  => 'rrs_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_rrs_grid_headers')
);
