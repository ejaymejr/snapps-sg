...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Quarterly PMS ', url_for('machine/pms1232QuarterlyAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'm1232quarterly_list_header_search',
    'pagerTemplate'  => 'm1232quarterly_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_m1232quarterly_grid_headers')
);
