...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add PMS Record ', url_for('machine/heatSealerpmAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => '',
    'pagerTemplate'  => 'heatsealerpm_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_heatsealerpm_grid_headers')
);
