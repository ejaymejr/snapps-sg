...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/daily6252Edit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'machine/daily6252Delete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getCdaDiWater()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getPreInspect()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getFluidLeak()) ?></td>
