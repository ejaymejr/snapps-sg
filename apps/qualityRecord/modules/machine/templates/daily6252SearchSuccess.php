...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Daily 6252 PMS ', url_for('machine/pms6252DailyAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'm6252daily_list_header_search',
    'pagerTemplate'  => 'm6252daily_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_m6252_grid_headers')
);
