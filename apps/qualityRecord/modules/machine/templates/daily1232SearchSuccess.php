...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Daily PMS ', url_for('machine/pms1232DailyAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'm1232_list_header_search',
    'pagerTemplate'  => 'm1232_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_m1232_grid_headers')
);
