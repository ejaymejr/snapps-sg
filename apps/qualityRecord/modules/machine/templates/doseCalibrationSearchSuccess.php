...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Dosing Calibraton ', url_for('machine/doseCalibrationAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'dcalib_list_header_search',
    'pagerTemplate'  => 'dcalib_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_dcalib_grid_headers')
);
