...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/weekly1232Edit?id=' . $record->getId());

$deleteLink = link_to('Delete', 'machine/weekly1232Delete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>" id="<?=$rowID?>"
	...
	<td class="alignCenter alignTop" nowrap><?php echo dispOk($record->getChamberTemp()) ?></td>
