...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Monthly PMS ', url_for('machine/pms1232MonthlyAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'm1232monthly_list_header_search',
    'pagerTemplate'  => 'm1232monthly_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_m1232monthly_grid_headers')
);
