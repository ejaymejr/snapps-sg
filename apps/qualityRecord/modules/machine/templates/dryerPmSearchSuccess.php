...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add PMS Record ', url_for('machine/dryerpmAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => '',
    'pagerTemplate'  => 'dryerpm_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_dryerpm_grid_headers')
);
