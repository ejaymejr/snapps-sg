...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/heatSealerPmEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'machine/heatSealerPmDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getAirRegulator()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getHeat()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getThermopatch()) ?></td>
	<td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getDwell()) ?></td>
	<td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getPiston()) ?></td>
	...
	<td class="alignCenter alignTop" nowrap > <?php echo $record->getVerifyDate() ?></td>
