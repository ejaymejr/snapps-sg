...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Weekly 6252 PMS ', url_for('machine/pms6252WeeklyAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'm6252week_list_header_search',
    'pagerTemplate'  => 'm6252week_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_m6252weekly_grid_headers')
);
