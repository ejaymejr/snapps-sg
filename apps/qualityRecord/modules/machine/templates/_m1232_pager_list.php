...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/daily1232Edit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'machine/daily1232Delete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getWashFlowRate() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getRinseFlowRate() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getCham1()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getCham2()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getPanelInspect()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getExitInspect()) ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo dispOk($record->getSwitchControl()) ?></td>
