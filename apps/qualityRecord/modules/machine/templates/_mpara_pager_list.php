...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/machineParameterEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'machine/machineParameterDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getTransTime() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getMachineNo() ?></td>
    
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getDiWater() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCda1() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCda2() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCdaDiff() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getSumptank() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getUltraTank() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getRinseTemp() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getCheckedBy() ?></td>
