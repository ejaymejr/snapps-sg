...
$desc = $record->getTransDate() . ' - ' .$record->getFlowRate();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/doseCalibrationEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'machine/doseCalibrationDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getDensity() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getPumpModel() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getEqFlowRate() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getFrequency() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getFlowRate() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getReadingTime() ?></td>
    <td class="alignCenter alignTop" nowrap > <?php echo $record->getReading() ?></td>
