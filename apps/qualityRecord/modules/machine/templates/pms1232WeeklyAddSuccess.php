...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('machine/pms1232WeeklyAdd'). '?id=' . $sf_params->get('id');?>"
	method="post">
	<div align="center">
<table width="90%" class="FORMtable" border="0" cellpadding="1"	cellspacing="0">
	<tr><td>
		<table width="100%" class="FORMtable" border="0" cellpadding="4"cellspacing="0">
			<tr><td height="32" colspan="6" align="center" bgcolor="#FFAC25" nowrap><span style="color: #FFF"><H2>WEEKLY 1232A/B PREVENTIVE MAINTENANCE SCHEDULE</H2></span></td></tr>
			<tr>
			...
			<tr>
				...
				<td class="FORMcell-left FORMlabel" nowrap></td>
				<td colspan="3" width="200" class="FORMcell-right" width="10" nowrap><?php
				echo '<span class="radioButtonText">' .checkbox_tag('chamber_temp', 1, is_checked($sf_params->get('chamber_temp')) ) . '&nbsp;&nbsp;Chamber Temperature</span>';
				?>
			</tr>					
			<tr>
				<td  class="FORMcell-right" nowrap></td>
