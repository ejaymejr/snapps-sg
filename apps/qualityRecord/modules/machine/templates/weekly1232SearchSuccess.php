...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add Weekly PMS ', url_for('machine/pms1232WeeklyAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => 'm1232week_list_header_search',
    'pagerTemplate'  => 'm1232week_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_m1232weekly_grid_headers')
);
