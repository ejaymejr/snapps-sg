...
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'machine/monthly1232Edit?id=' . $record->getId());

$deleteLink = link_to('Delete', 'machine/monthly1232Delete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>" id="<?=$rowID?>"
	...
	<td class="alignCenter alignTop" nowrap><?php echo dispOk($record->getDrainSystem()) ?></td>
	<td class="alignCenter alignTop" nowrap><?php echo dispOk($record->getElectricalSystem()) ?></td>
	<td class="alignCenter alignTop" nowrap><?php echo dispOk($record->getHosesConnectors()) ?></td>
