...
<?php echo HTMLForm::DrawButton('pushbutton1', 'button1', 'Add PMS Record ', url_for('machine/washerpmAdd')); ?>
</div>
<?php
$gridVars = array(
    'searchTemplate' => '',
    'pagerTemplate'  => 'washerpm_pager_list',
    'baseURL' => $sf_request->getModuleAction(),
    'pager' => $pager,
    'searchContainerID' => XIDX::next(),
    'headers' => sfConfig::get('app_washerpm_grid_headers')
);
