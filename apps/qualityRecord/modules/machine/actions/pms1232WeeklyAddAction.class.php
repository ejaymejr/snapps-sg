 ...
 */
class pms1232WeeklyAddAction extends SnappsAction
{
    var $preCount = 0;
    ...
    public function preExecute()
    {
        ...
        if (!$this->record)
        {
            $this->record = new Pms1232abWeekly();
    ...
    public function execute()
    {
        if ($this->getRequest()->getMethod() == sfRequest::POST)
        {
            ...
            $this->record->setChamberTemp($this->_G('chamber_temp'));
            ...
            $this->redirect('machine/weekly1232Search?hIDs[]=' . $this->record->getId());
        }
    }
