...
<li class="<?php echo $menuItemClass; ?>">

<?php
	echo link_to($menu, '', 'class="menuanchorclass" rel="menu'.$element.'"' ); 
?>
<?php //echo link_to($menu[0], '', 'class="menuanchorclass" rel="anylinkmenu1[click]" '); ?>
</li>
